...
export default (token) => {
    ...
    const createProfile = async data => {
        const response = await request(`${apiUrl}user/createProfile`, 'POST', data, {
    ...
    const getProfiles = async () => {
        const response = await request(`${apiUrl}user/getProfiles`, 'GET', null, {
            Authorization: `Bearer ${token}`
        });
    ...
    const updateProfile = async data => {
        const response = await request(`${apiUrl}user/updateProfile`, 'POST', data);
